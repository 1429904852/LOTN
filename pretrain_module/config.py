...
# tf.app.flags.DEFINE_string('saver_checkpoint', 'data/amazon/checkpoint', 'prob')

tf.app.flags.DEFINE_string('train_file_path', 'data/yelp/sentiment_label_train.txt', 'training file')
tf.app.flags.DEFINE_string('validate_file_path', 'data/yelp/sentiment_label_test.txt', 'validating file')
tf.app.flags.DEFINE_string('test_file_path', 'data/yelp/sentiment_label_test.txt', 'testing file')
tf.app.flags.DEFINE_string('embedding_file_path', 'data/yelp/yelp_2014_840b_300.txt', 'embedding file')
